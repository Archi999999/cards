...
export const CreatePassword = () => {
  ...
  return (
    <Card>
      ...
      <TextField autoFocus variant={'input'} name={'password'} label={'Password'} value={password} onValueChange={onChangeHandler} error={error}/>
      <Typography as={'span'} className={s.text}>
        Create new password and we will send you further instructions to email
      </Typography>
      <Button className={s.button} onClick={onClickHandler}>Create new password</Button>
    </Card>
  );
};
